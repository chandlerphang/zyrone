...
public class ClassUtil {
    ...
    public static Class<?> getArrayClass(Class<?> componentClass, int dimension) {
        ...
        switch (dimension) {
            ...
            default:
                Assert.isTrue(dimension > 0, "wrong dimension: %d", dimension);
    ...
    static {
        ...
        Assert.isTrue(assignmentTable.size() == 8);
    }
    ...
    public static String locateClass(String className, ClassLoader loader) {
        className = Assert.notNull(trimToNull(className), "className");
